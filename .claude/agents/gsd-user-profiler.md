...
<reference>
@/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/references/user-profiling.md` to load:
