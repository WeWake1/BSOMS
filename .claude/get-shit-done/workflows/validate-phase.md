...
```
Task(
  prompt="Read /Users/wewake/AnitGrav/BhaktiSales/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/templates/VALIDATION.md`
