...
INSTALL_JS_GLOBAL="/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
