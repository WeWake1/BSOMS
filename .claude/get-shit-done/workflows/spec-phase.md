...
```bash
INIT=$(node "/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/templates/spec.md.
