...
- **Global scope**: `/Users/wewake/AnitGrav/BhaktiSales/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/wewake/AnitGrav/BhaktiSales/.claude/notes/`)
...
2. Glob `/Users/wewake/AnitGrav/BhaktiSales/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/wewake/AnitGrav/BhaktiSales/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/wewake/AnitGrav/BhaktiSales/.claude/notes/` — works in any directory
