...
- Usage: Reference from command with `@/Users/wewake/AnitGrav/BhaktiSales/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/wewake/AnitGrav/BhaktiSales/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/wewake/AnitGrav/BhaktiSales/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
