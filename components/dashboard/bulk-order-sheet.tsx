...
export function BulkOrderSheet({ isOpen, onClose, categories, existingCustomerNames = [], customerMobileLookup }: BulkOrderSheetProps) {
  ...
  const sheet = (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      <button className="absolute inset-0 bg-black/40 w-full h-full text-transparent focus:outline-none cursor-default"
        ...
        <div className="flex-1 overflow-auto overscroll-contain">
          <table className="w-full border-collapse text-sm min-w-[900px] lg:min-w-0">
            <thead className="sticky top-0 z-10">
              <tr className="bg-muted border-b border-border text-muted-foreground text-[11px] font-bold uppercase tracking-wider">
