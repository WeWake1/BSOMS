        ...
        <div className="flex gap-2 flex-1">
          <div className="flex bg-muted p-1 rounded-xl border border-border shrink-0">
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors flex items-center justify-center min-tap ${viewMode === 'card' ? 'bg-background shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
            ...
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors flex items-center justify-center min-tap ${viewMode === 'list' ? 'bg-background shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
