...
// Service role client for admin server-side operations (does not use cookies)
export function createServiceClient() {
  // Import createClient from the base package directly (no SSR wrapper needed for service role)
