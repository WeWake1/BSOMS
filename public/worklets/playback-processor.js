/**
 * Playback worklet for the Gemini Live API.
 * Queues incoming Float32 PCM chunks (24kHz model output) and streams them to
 * the speaker. Clears its queue on an 'interrupt' message for barge-in.
 * Uses an offset tracker instead of slice() to avoid allocations on the audio thread.
